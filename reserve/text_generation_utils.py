...
from reserve import print_rank_0
from reserve import mpu
from reserve.utils import get_ltor_masks_and_position_ids, is_mp_rank_0
...
def stream_tokens(
    ...
    with torch.no_grad():
        ...
        while token_index_to_generate <= last_token_index_to_generate:
            ...
            original_generated_token_logits = generated_token_logits
            ...
            if logits is not None:
                ...
                if neox_args.return_logits:
                    # TODO: change to original logits
                    # starting from 0
                    generation_logits[
                        return_logits_idx
                    ] = original_generated_token_logits
                    return_logits_idx += 1
