...
from reserve import fused_kernels
from reserve import mpu
from reserve.mpu import set_model_parallel_rank, set_model_parallel_world_size
...
def initialize_megatron(neox_args, allow_no_cuda=False):
    ...
    if neox_args.lazy_mpu_init:
        ...
        if neox_args.local_rank == 0:
            from reserve.data.data_utils import compile_helper
